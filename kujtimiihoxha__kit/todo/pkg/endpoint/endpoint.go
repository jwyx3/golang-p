...
import (
	...
	service "golang-p/kujtimiihoxha__kit/todo/pkg/service"
...
func (e Endpoints) Get(ctx context.Context) (t []model.Todo, error error) {
	request := GetRequest{}
...
func (e Endpoints) Add(ctx context.Context, todo model.Todo) (t model.Todo, error error) {
