...
import (
	"context"
	"golang-p/kujtimiihoxha__kit/todo/pkg/model"
)

// TodoService describes the service.
type TodoService interface {
	Get(ctx context.Context) (t []model.Todo, error error)
	Add(ctx context.Context, todo model.Todo) (t model.Todo, error error)
...
func (b *basicTodoService) Get(ctx context.Context) (t []model.Todo, error error) {
	// TODO implement the business logic of Get
	return t, error
}
func (b *basicTodoService) Add(ctx context.Context, todo model.Todo) (t model.Todo, error error) {
